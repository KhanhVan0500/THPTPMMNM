<?php
$seoTitle = 'Thanh toán — KZANN';
$seoDescription = 'Hoàn tất đơn hàng tại KZANN.';
            ...
            <div class="card-body">
                ...
                <form action="index.php?url=order/place" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div id="paymentInfoBANK" class="payment-info"><strong>Chuyển khoản:</strong> KZANN STORE - STK 0909999099 - Ngân hàng MB Bank. Nội dung: SĐT + mã đơn.</div>
                        <div id="paymentInfoMOMO" class="payment-info"><strong>MOMO:</strong> Quét ví 0909 999 099 - KZANN Store. Hệ thống ghi nhận sau khi xác nhận đơn.</div>
                    </div>
