    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-4">
                <h5 class="font-display"><i class="fas fa-atom mr-2" style="color:var(--primary);"></i>KZANN</h5>
                <p>Cửa hàng điện thoại chính hãng, giá tốt nhất, dịch vụ tận tâm. Phục vụ khách hàng từ 2020 tại Dĩ An, Bình Dương.</p>
                <p><i class="fas fa-phone-alt mr-2"></i>0909 999 099</p>
                <p><i class="fas fa-map-marker-alt mr-2"></i>Dĩ An, Bình Dương</p>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center">
            <p class="mb-2 mb-md-0" style="font-size:.8rem;">&copy; <?= date('Y') ?> KZANN Store. Dịch vụ từ tâm.</p>
...
<div class="support-fab" aria-label="Hỗ trợ nhanh">
    ...
    <a href="#" title="Chat hỗ trợ" onclick="showToast('Hỗ trợ KZANN đang sẵn sàng.');return false;"><i class="fas fa-headset"></i></a>
</div>
